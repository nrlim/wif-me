...
export const ROLE_NAV_ITEMS: Record<string, readonly NavigationItem[]> = {
  ...
  muthawif: [
    ...
    { labelKey: "roles.muthawif.withdrawals", href: "/muthawif/withdrawals", icon: WalletCards },
  ],
  provider: [
    ...
    { labelKey: "roles.provider.withdrawals", href: "/provider/withdrawals", icon: WalletCards },
  ],
  admin: [
    ...
    { labelKey: "roles.admin.locationLookup", href: "/admin/lookup/locations", icon: MapPin },
    {
